...
class budget(models.Model):
    ...
    approval = models.BooleanField("预算核准")
    budgetmoney = models.DecimalField("预算金额(未税)",max_digits = 16,decimal_places = 2,null = True,blank = True,default = 0.00)
    longcontract = models.BooleanField("是否长期合同")
    countdraw = models.BooleanField("是否计提")
...
class pr(models.Model):
    ...
    prname = models.CharField("采购名称",max_length = 128)
    po = models.DecimalField("PO号",max_digits = 10,decimal_places = 0,default = 0)
    contract = models.BooleanField("合同完成")
